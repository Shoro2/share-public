...
| 2 | 900301 | Rune Weapon double-casts | C++ | implemented | Marker aura (DUMMY). C++ AuraScript on DRW (49028): `OnEffectProc` → extra CastSpell/DealMeleeDamage. Checks `HasAura(900301)`. Rune Weapon casts every spell 2× instead of 1×. |
