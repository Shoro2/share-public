...
| 3 | 900668 | Hemorrhage +9 targets | C++ | implemented | DUMMY marker. C++ SpellScript on Hemo (-48660): `AfterHit` → finds up to 9 enemies in an 8yd radius → CastCustomSpell(900669, damage)  on each. Checks `HasAura(900668)`. |
