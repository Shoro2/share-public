...
|---|----------|--------|--------|--------|---------|
| 1 | 900366 | DoTs → Shadow AoE proc | C++ | implemented | Proc aura (DUMMY). spell_proc: ProcFlags=0x400000 (DONE_PERIODIC), 20% chance, 2s ICD. C++ HandleProc → CastSpell(900367, triggered) on the DoT target. |
