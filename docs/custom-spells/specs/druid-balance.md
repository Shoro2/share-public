...
|---|----------|--------|--------|--------|---------|
| 1 | 901000 | Moonfire +9 targets | C++ | implemented | DUMMY marker. C++ SpellScript on Moonfire (-48463): `AfterHit` → finds up to 9 enemies in a 10yd radius → CastSpell(Moonfire R14, triggered)  on each. Checks `HasAura(901000)`. |
